...
If you expose the dashboard beyond localhost, add authentication, TLS, a reviewed proxy configuration and a new threat model first; that is outside v0.2.3.
